    ...
    <footer data-testid="site-footer" className="relative bg-ink-950 border-t border-ink-800/80">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-ink-800/80">
          <div className="lg:col-span-7">
            ...
            <h3 className="font-display text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-ink-50 leading-[1.02] text-balance">
              ...
              <span className="text-signal-500">industrial intelligence</span>.
            </h3>
          </div>
            ...
            <div className="flex items-center gap-2 mt-6">
              {([Linkedin, Twitter, Youtube] as const).map((Icon, i) => (
                <a
                  ...
                  href="#"
                  aria-label="social"
                  className="w-10 h-10 grid place-items-center border border-ink-800 hover:border-signal-500 hover:text-signal-500 text-ink-300 transition-colors"
                >
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={item.l}>
                  <Link href={item.to} className="text-ink-200 hover:text-signal-500 transition-colors">
                    {item.l}
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-sm">
              {SERVICES.slice(0, 5).map((s) => (
                <li key={s.id}>
                  <Link href="/products" className="text-ink-200 hover:text-signal-500 transition-colors">
                    {s.title}
                  </Link>
                </li>
              ))}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-8 border-t border-ink-800/80">
          <p className="font-mono text-[11px] tracking-wider text-ink-400">
            © {new Date().getFullYear()} VJS Smart Systems — All rights reserved.
          </p>
