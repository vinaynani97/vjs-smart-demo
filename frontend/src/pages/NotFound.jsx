  ...
  return (
    <div data-testid="not-found-page" className="relative min-h-[70vh] grid place-items-center overflow-hidden">
      ...
      <div className="relative text-center max-w-xl px-6">
        ...
        <Link to="/" className="group inline-flex items-center gap-2 mt-10 bg-signal-500 hover:bg-signal-600 text-white px-7 py-4 text-xs font-mono uppercase tracking-[0.2em]">
