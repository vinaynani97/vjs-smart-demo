...
const initialForm = {
  ...
  product_interest: "", project_requirement: "", message: "",
};
            ...
            <div className="border border-ink-800 bg-ink-900/40">
              ...
              {submitted ? (
                <div data-testid="contact-success" className="p-12 text-center">
                  <div className="w-14 h-14 grid place-items-center bg-signal-500 mx-auto"><Check className="w-6 h-6 text-white" /></div>
                  ...
                  <button onClick={() => setSubmitted(false)} data-testid="send-another" className="mt-8 inline-flex items-center gap-2 border border-ink-700 hover:border-signal-500 hover:text-signal-500 px-6 py-3 font-mono text-xs uppercase tracking-[0.2em] transition-colors">
                ...
                <form onSubmit={onSubmit} data-testid="contact-form" className="p-8 grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea name="message" required value={form.message} onChange={onChange} rows={5}
                  ...
                  <div className="md:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:justify-between pt-4 border-t border-ink-800">
                    ...
                    <button data-testid="contact-submit" type="submit" disabled={submitting} className="group inline-flex items-center justify-center gap-2 bg-signal-500 hover:bg-signal-600 disabled:opacity-60 text-white px-8 py-4 text-xs font-mono uppercase tracking-[0.2em] transition-colors">
...
const Field = ({ name, label, value, onChange, type = "text", required = false, className = "" }) => (
