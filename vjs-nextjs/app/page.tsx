    ...
    <div className="relative max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center py-24 lg:py-0">
      ...
      <div className="lg:col-span-5 relative">
        ...
        >
          ...
          <div className="h-1 bg-ink-800 mt-3">
            <div className="h-full bg-signal-500 w-[99%]" />
          </div>
        </motion.div>
      </div>
    </div>
    ...
    <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 grid grid-cols-2 lg:grid-cols-4">
      {STATS.map((s, i) => (
        <Reveal key={s.label} delay={i * 0.08}>
          <div
            className={`py-10 lg:py-14 ${i !== 0 ? "lg:border-l border-ink-800/80" : ""} ${
              i % 2 !== 0 ? "border-l lg:border-l border-ink-800/80" : ""
            }`}
          >
  ...
  <section data-testid="home-services" className="py-28 lg:py-40 bg-ink-900/30 border-y border-ink-800/80">
    <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16">
      ...
      <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-l border-t border-ink-800/80">
        {SERVICES.map((s) => {
          const Icon = ((Icons as unknown as Record<string, LucideIcon>)[s.icon] ?? Icons.Cpu) as LucideIcon;
          return (
            <StaggerItem key={s.id}>
              <div
                data-testid={`service-${s.id}`}
                className="group relative p-8 lg:p-10 border-r border-b border-ink-800/80 hover:bg-ink-900/60 transition-colors"
              >
        ...
        <StaggerItem>
          <div className="relative p-8 lg:p-10 border-r border-b border-ink-800/80 bg-signal-500 text-white flex flex-col justify-between min-h-[220px]">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] mt-6"
            >
          ...
          <StaggerItem key={ind.name}>
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5">
                <p className="font-mono text-[10px] text-signal-400 uppercase tracking-wider">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-14 items-end">
          ...
          <div className="lg:col-span-3 lg:col-start-10 flex lg:justify-end">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 border border-ink-700 hover:border-signal-500 hover:text-signal-500 px-6 py-3 font-mono text-xs uppercase tracking-[0.2em] transition-colors"
            >
            ...
            <StaggerItem key={p.slug}>
              ...
              >
                ...
                <div className="p-6 lg:p-8">
                  <h3 className="font-display text-xl lg:text-2xl font-medium tracking-tight text-ink-50 group-hover:text-signal-500 transition-colors">
                    {p.name}
                  </h3>
      ...
      <div className="max-w-3xl">
        ...
        <div className="mt-12 flex flex-wrap gap-3">
          <Link
            ...
            className="group inline-flex items-center gap-2 bg-signal-500 hover:bg-signal-600 text-white px-8 py-5 text-xs font-mono uppercase tracking-[0.2em]"
          >
            Contact Us{" "}
            <ArrowUpRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
          </Link>
          <Link
            ...
            className="inline-flex items-center gap-2 border border-ink-700 hover:border-signal-500 hover:text-signal-500 text-ink-100 px-8 py-5 text-xs font-mono uppercase tracking-[0.2em] transition-colors"
          >
            Request a Quote
          </Link>
        </div>
